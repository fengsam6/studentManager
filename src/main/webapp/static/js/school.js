...
function deteteSchool(url, schoolId) {
...
function editPage(schoolId) {
    layerIndex = layer.open({
        ...
        fixed: false, //不固定
        maxmin: true,
        content: contextPath+'/school/edit.html?schoolId=' + schoolId
    });
}
...
$(".addPage_btn").click(function () {
    layerIndex = layer.open({
        ...
        fixed: false, //不固定
        maxmin: true,
        content: contextPath+'/school/add.html'
    });
});
$(".showPage_btn").click(function () {
    layerIndex = layer.open({
        ...
        fixed: false, //不固定
        maxmin: true,
        content: contextPath+'/school/detail.html'
    });
});
