...
<form class="layui-form">
    <blockquote class="layui-elem-quote quoteBox">
        <form class="layui-form">
            ...
            <div class="layui-inline">
                <a class="layui-btn layui-btn-normal addPage_btn" href="javascript:void(0);">添加角色</a>
            </div>
            <div class="layui-inline">
    ...
    <table class="layui-table">
        ...
        <tbody>
        <c:forEach var="role" items="${roleListModal}">
            <tr>
                ...
                <td><a href="javascript:editPage(${role.id});" class="layui-btn layui-btn-xs ">编辑</a></td>
                <td><a href="javascript:deteteRole(${role.id } );"
