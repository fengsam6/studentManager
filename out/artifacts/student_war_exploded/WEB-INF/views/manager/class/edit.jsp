...
<form class="layui-form layui-row editForm" action="${baseUrl}/class/update">
    <div class="layui-container">
        <div class="layui-col-md6 layui-col-xs12">
            <input type="hidden" name="id" value="${classObjModel.id}">
            <div class="layui-form-item">
                <label class="layui-form-label">班级名称</label>
                <div class="layui-input-block">
                    <input type="text" name="className" placeholder="请输入班级名称" lay-verify="required"
                           class="layui-input " value="${classObjModel.className}">
                </div>
            </div>
            <div class="layui-form-item">
